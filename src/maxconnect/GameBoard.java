...
public void setAiTurn(boolean value) {   // to set the turn is Ai or human
	ai_turn = value;
}
...
public int getThrees( int player ) // this function is same as the getscore but checks for only three player counts
{
	//reset the scores
	int playerScore = 0;
